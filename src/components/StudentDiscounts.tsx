...
export default function StudentDiscounts({ studentId }: StudentDiscountsProps) {
    ...
    const createMutation = useMutation({
        ...
        onError: (error: any) => {
            setError(error?.response?.data?.error || 'Failed to add discount');
        },
    });
    ...
    const updateMutation = useMutation({
        ...
        onError: (error: any) => {
            setError(error?.response?.data?.error || 'Failed to update discount');
        },
    });
    ...
    const deleteMutation = useMutation({
        ...
        onError: (error: any) => {
            setError(error?.response?.data?.error || 'Failed to delete discount');
        },
    });
    ...
    const handleDelete = (id: number, feeTypeName: string) => {
        if (confirm(`Are you sure you want to delete the discount for "${feeTypeName}"?`)) {
