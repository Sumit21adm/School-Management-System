...
import { promotionService, classService, sessionService } from '@/lib/api';
...
export default function StudentPromotions() {
    ...
    return (
        <Box sx={{ maxWidth: 1200, mx: 'auto' }}>
            ...
            <Paper sx={{ p: 3, mb: 3 }}>
                <Typography variant="h6" gutterBottom>Step 1: Select Class & Section</Typography>
            ...
            {meta && students.length > 0 && (
                <>
                    <Paper sx={{ p: 3, mb: 3 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 1 }}>
                                <Button onClick={handleSelectAll} size="small">Select All Active</Button>
                    ...
                    <Paper sx={{ p: 3 }}>
                        <Typography variant="h6" gutterBottom>Step 3: Set Promotion Details</Typography>
