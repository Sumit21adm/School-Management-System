...
let DiscountsController = class DiscountsController {
    ...
    findByStudent(studentId, sessionId) {
        return this.discountsService.findByStudent(studentId, sessionId ? parseInt(sessionId) : undefined);
    }
...
], DiscountsController.prototype, "findByStudent", null);
__decorate([
    (0, common_1.Post)(),
