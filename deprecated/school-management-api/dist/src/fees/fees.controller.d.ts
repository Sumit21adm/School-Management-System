...
export declare class FeesController {
    ...
    private readonly demandBillPdfService;
    private readonly prisma;
    constructor(feesService: FeesService, receiptPdfService: ReceiptPdfService, demandBillPdfService: DemandBillPdfService, prisma: PrismaService);
    ...
    getReceiptPdf(receiptNo: string, res: Response): Promise<void>;
    getDemandBillPdf(billNo: string, res: Response): Promise<void>;
    getBatchDemandBillPdf(body: {
        billNumbers: string[];
        period?: string;
        billType?: string;
        classInfo?: string;
