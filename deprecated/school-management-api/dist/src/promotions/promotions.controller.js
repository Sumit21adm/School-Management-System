...
const promote_students_dto_1 = require("./dto/promote-students.dto");
let PromotionsController = class PromotionsController {
    promotionsService;
    constructor(promotionsService) {
        this.promotionsService = promotionsService;
    }
    async previewPromotion(currentSessionId, className, section) {
    ...
    async executePromotion(promoteStudentsDto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Query)('currentSessionId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Query)('className')),
    __param(2, (0, common_1.Query)('section')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, String, String]),
    __metadata("design:returntype", Promise)
], PromotionsController.prototype, "previewPromotion", null);
__decorate([
    (0, common_1.Post)('execute'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [promote_students_dto_1.PromoteStudentsDto]),
    __metadata("design:returntype", Promise)
], PromotionsController.prototype, "executePromotion", null);
